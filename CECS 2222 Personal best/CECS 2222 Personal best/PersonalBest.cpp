...
PersonalBest::PersonalBest(string aName, double aMeters, int aMonth, int aDay, int aYear)
{
	setName(aName);
	setMeters(aMeters);
...
void PersonalBest::setAthlete(string aName, double aMeters, int aMonth, int aDay, int aYear)
{
	name = aName;
	*meters = aMeters;
	setDate(aMonth, aDay, aYear);
...
void PersonalBest::setName(string aName)
{
	name = aName;
}
...
string PersonalBest::getName() const
{
	return name;
}
