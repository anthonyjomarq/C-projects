...
//Create function that takes variable by reference and calculates pay for 2 pay periods
void SecondPaycheck(float& Secondperiod)
{
	Secondperiod *= 2.0;
	cout << "If you work the same hours, in total in two periods you will get payed: $" << Secondperiod << endl;
